...
if it contains a syntax error the program will stop, and the symbol table will be shown in a file called
‘SymbolTable.txt’ and the equivalent quadruples will be shown in the window or in a file called
‘out.txt’
